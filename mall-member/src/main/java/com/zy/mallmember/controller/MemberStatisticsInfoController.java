...
import com.zy.mallmember.excel.MemberStatisticsInfoExcel;
...
public class MemberStatisticsInfoController {
    ...
    //@RequiresPermissions("mallmember:memberstatisticsinfo:page")
    ...
    @LogOperation("导出")
    //@RequiresPermissions("mallmember:memberstatisticsinfo:export")
