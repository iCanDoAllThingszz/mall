...
import com.zy.mallmember.excel.MemberCollectSpuExcel;
...
public class MemberCollectSpuController {
    ...
    //@RequiresPermissions("mallmember:membercollectspu:page")
    ...
    @LogOperation("导出")
    //@RequiresPermissions("mallmember:membercollectspu:export")
