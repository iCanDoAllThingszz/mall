...
import com.zy.mallproduct.excel.ProductAttrValueExcel;
...
public class ProductAttrValueController {
    ...
    //@RequiresPermissions("mallproduct:productattrvalue:page")
    ...
    @LogOperation("导出")
    //@RequiresPermissions("mallproduct:productattrvalue:export")
